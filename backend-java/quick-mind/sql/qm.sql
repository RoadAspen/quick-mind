...
values
(100,  0,   '0',          '捷智科技',   0, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(101,  100, '0,100',      '深圳总公司', 1, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(102,  100, '0,100',      '长沙分公司', 2, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(103,  101, '0,100,101',  '研发部门',   1, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(104,  101, '0,100,101',  '市场部门',   2, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(105,  101, '0,100,101',  '测试部门',   3, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(106,  101, '0,100,101',  '财务部门',   4, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(107,  101, '0,100,101',  '运维部门',   5, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(108,  102, '0,100,102',  '市场部门',   1, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate()),
(109,  102, '0,100,102',  '财务部门',   2, '牛油果', '15888888888', 'niuyouguo@qq.com', '0', '0', 'admin', sysdate(), 'admin', sysdate());
...
('4', '牛油果官网', '0', '4', 'http://niuyouguo.com', null, '', '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '牛油果官网地址'),
-- 二级菜单
...
(7, '用户管理-初始密码修改策略',     'sys.account.initPasswordModify',   '1',             'Y', 'admin', sysdate(), '', null, '0：初始密码修改策略关闭，没有任何提示，1：提醒用户，如果未修改初始密码，则在登录时就会提醒修改密码对话框'),
(8, '用户管理-账号密码更新周期',     'sys.account.passwordValidateDays', '0',             'Y', 'admin', sysdate(), '', null, '密码更新周期（填写数字，数据初始化值为0不限制，若修改必须为大于0小于365的正整数），如果超过这个周期登录系统时，则在登录时就会提醒修改密码对话框');
...
(1, '系统默认（无参）', 'DEFAULT', 'qmTask.qmNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, ''),
(2, '系统默认（有参）', 'DEFAULT', 'qmTask.qmParams(\'qm\')',  '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, ''),
(3, '系统默认（多参）', 'DEFAULT', 'qmTask.qmMultipleParams(\'qm\', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
...
('1', '温馨提醒：2018-07-01 牛油果新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员'),
('2', '维护通知：2018-07-01 牛油果系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
